...
var mongooseEncryption = function(schema, options) {
    ...
    schema.methods.decryptSync = function() {
        ...
        if (this._ct) {
            ...
            if (handleDecryptionConflict && that.$isDefault) {
                ...
                unSecretData = pick(
                    this,
                    _.filter(encryptedFields, field => !that.$isDefault(field)),
            ...
            if (handleDecryptionConflict) {
                unExposedData = getExtraData(encryptedFields, decryptedObject);
            }
            ...
            if (handleDecryptionConflict && (!_.isEmpty(unSecretData) || !_.isEmpty(unExposedData))) {
                handleDecryptionConflict.call(this, {encryptedFields, unSecretData, unExposedData});
            }
