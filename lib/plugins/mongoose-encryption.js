...
var handleDecryptionConflictDefault = function (diff) {
    ...
    var error = new Error(
        'Conflict detected when decrypting ' + this.constructor.modelName + ' record.\n\n' +
...
var mongooseEncryption = function(schema, options) {
    ...
    schema.methods.decryptSync = function(doc) {
        ...
        if (this._ct) {
            ...
            if (handleDecryptionConflict && doc && doc.$isDefault) {
            ...
            if (handleDecryptionConflict && doc && (!_.isEmpty(unSecretData) || !_.isEmpty(unExposedData))) {
                handleDecryptionConflict.call(doc, {encryptedFields, unSecretData, unExposedData});
            }
